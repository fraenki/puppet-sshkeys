...
describe 'sshkeys' do
  ...
  context 'e2e test with hiera data' do
    it do
      ...
      should contain_ssh_authorized_key('third_test_key_at_sometestuser@some.fqdn')
        .with(
          ensure: 'present',
          user: 'sometestuser',
          key: '',
  ...
  context 'e2e test with direct parameters, without hiera data' do
    ...
    it do
      ...
      should contain_ssh_authorized_key('third_test_key_at_sometestuser2@some.fqdn.without-hiera-data')
        .with(
          ensure: 'present',
          user: 'sometestuser2',
          key: '',
